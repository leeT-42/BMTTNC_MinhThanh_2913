...
class QuanLySinhVien:
    ...
    def updateSinhVien(self, ID):
        ...
        if (sv != None):
            ...
            sv._sex = sex
            sv._major = major
            sv._diemTB = diemTB # Thêm dòng này để cập nhật diemTB
            self.xepLoaiHocLuc(sv) # Cập nhật học lực sau khi thay đổi điểm
        else:
    ...
    def showSinhVien(self, listSV):
        print("{:<8}{:<18}{:<8}{:<18}{:<8}{:<8}".format("ID", "Name", "Sex", "Major", "Diem TB", "Hoc Luc"))
        if (len(listSV) > 0):
            for sv in listSV:
