...
previous_hash = previous_block.hash  # Đã sửa từ previous_block_hash thành previous_block.hash
my_blockchain.add_transaction('Genesis', 'Miner', 1)
new_block = my_blockchain.create_block(new_proof, previous_hash)

# Displaying the blockchain
for block in my_blockchain.chain:
    print(f"Block #{block.index}")  # Đã sửa để sử dụng f-string
...
print("Is Blockchain Valid:", my_blockchain.is_chain_valid(my_blockchain.chain))  # Đã sửa khoảng trắng sau "my_blockchain."